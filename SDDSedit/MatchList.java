				...
				if (isVisible()
					...
					if (value.equals(btnString1)) {
						...
						for (i = 0; i < length; i++) {
							...
							row = Integer.valueOf(((String) selectedValues[i]).substring(indexStart + 1, indexEnd))
									.intValue() - 1;
							col = Integer.valueOf(((String) selectedValues[i]).substring(indexEnd + 1,
									((String) selectedValues[i]).length())).intValue() - 1;
